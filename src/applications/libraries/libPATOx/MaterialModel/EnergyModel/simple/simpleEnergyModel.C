...
const Foam::word Foam::simpleEnergyModel::modelName="Energy";
...
)
{
  ...
  if (MaterialDict.isDict("Energy")) {
    ...
    EnergyModelTypeName =
        word(EnergyModelDict.lookupOrDefault<word>("EnergyType","no"));
  ...
  return autoPtr<simpleEnergyModel>(cstrIter()(mesh, regionName));
}
