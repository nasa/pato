...
plot(data[:,0],data[:,8],ls='solid', color = "magenta",linewidth=2,label="TC8", alpha = 0.8)
plot(data[:,0],data[:,9],ls='solid', color = "cyan",linewidth=2,label="TC9", alpha = 0.8)
plot(data[:,0],data[:,10],ls='solid', color = "black",linewidth=2,label="TC10", alpha = 0.8)
# tight layout
plt.tight_layout()
# add grid
plt.grid()
