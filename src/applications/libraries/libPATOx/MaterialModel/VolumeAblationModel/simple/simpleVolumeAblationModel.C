...
const Foam::word Foam::simpleVolumeAblationModel::modelName="VolumeAblation";
...
)
{
  ...
  if (MaterialDict.isDict("VolumeAblation")) {
    ...
    VolumeAblationModelTypeName =
        word(VolumeAblationModelDict.lookupOrDefault<word>("VolumeAblationType","no"));
  ...
  return autoPtr<simpleVolumeAblationModel>(cstrIter()(mesh, regionName));
}
