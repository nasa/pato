...
PATOFileList_.append("../output/"+region+"/scalar/rho_s_plot")
...
plot(data[:,0],data[:,1],ls='solid', color = "black",linewidth=2,label="TC1", alpha = 0.8)
plot(data[:,0],data[:,2],ls='solid', color = "grey",linewidth=2,label="TC2", alpha = 0.8)
# tight layout
plt.tight_layout()
# add grid
plt.grid()
