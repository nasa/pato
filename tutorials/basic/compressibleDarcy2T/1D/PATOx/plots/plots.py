...
plot(DataTBas[::3,0],DataT3[::3,1],'vb', markersize=4, mfc='none',label='5s')
plot(DataTBas[::3,0],DataT4[::3,1],'^g', markersize=4, mfc='none',label='10s')
plot(DataTBas[::3,0],DataT5[::3,1],'sc', markersize=4, mfc='none',label='15s')
...
plot(DataTBas[::3,0],DataT3[::3,3],'vb', markersize=4, mfc='none',label='5s')
plot(DataTBas[::3,0],DataT4[::3,3],'^g', markersize=4, mfc='none',label='10s')
plot(DataTBas[::3,0],DataT5[::3,3],'sc', markersize=4, mfc='none',label='15s')
...
plot(DataTBas[::3,0],DataT3[::3,2],'vb', markersize=4, mfc='none',label='5s')
plot(DataTBas[::3,0],DataT4[::3,2],'^g', markersize=4, mfc='none',label='10s')
plot(DataTBas[::3,0],DataT5[::3,2],'sc', markersize=4, mfc='none',label='15s')
