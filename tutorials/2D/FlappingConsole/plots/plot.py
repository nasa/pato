...
region = "solid"
PATOFileList_=[]
PATOFileList_.append("../output/"+region+"/vector/Dx_surfacePatch")
...
plot(data[:,0],data[:,1],ls='solid', color = "black",linewidth=2,label="console front", alpha = 0.8)
