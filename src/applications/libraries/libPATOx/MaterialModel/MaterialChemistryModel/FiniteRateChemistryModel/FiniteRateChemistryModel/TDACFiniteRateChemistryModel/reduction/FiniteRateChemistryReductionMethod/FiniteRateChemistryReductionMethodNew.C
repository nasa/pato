...
Foam::autoPtr<Foam::FiniteRateChemistryReductionMethod<CompType, ThermoType>>
    Foam::FiniteRateChemistryReductionMethod<CompType, ThermoType>::New
    (
    ...
    )
{
  ...
  return autoPtr<FiniteRateChemistryReductionMethod<CompType, ThermoType>>
         (
