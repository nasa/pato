...
region = "porousMat"
PATOFileList_=[]
PATOFileList_.append("../output/"+region+"1/scalar/Ta_surfacePatch")
PATOFileList_.append("../output/"+region+"1/scalar/Ta_plot")
PATOFileList_.append("../output/"+region+"2/scalar/Ta_plot")
...
plot(data[:,0],data[:,1],ls='dashed', color = "black",linewidth=2, label="TC2", alpha = 0.8)
# tight layout
plt.tight_layout()
# add grid
plt.grid()
