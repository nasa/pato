...
defineTypeNameAndDebug(Porous_constMaterialPropertiesModel, 0);
addToRunTimeSelectionTable(simpleMaterialPropertiesModel, Porous_constMaterialPropertiesModel, fvMesh);
