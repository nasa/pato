...
PATOFileList_.append("../output/"+region+"/scalar/recession_surfacePatch")
...
# Create labels 
ax.set_xlabel('Time (s)', fontsize=16)
ax.set_ylabel('Recession (mm)', fontsize=16)
tick_params(axis='x', top='off')
tick_params(axis='y', right='off')
# x limit       
xlim(0,133)
...
plot(data[:,0],data[:,1]*1e3,ls='solid', color = "black",linewidth=2, alpha = 0.8)
# tight layout
plt.tight_layout()
# add grid  
plt.grid()
