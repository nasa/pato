...
Foam::autoPtr<Foam::FiniteRateChemistryTabulationMethod<CompType, ThermoType>>
    Foam::FiniteRateChemistryTabulationMethod<CompType, ThermoType>::New
    (
    ...
    )
{
  ...
  return autoPtr<FiniteRateChemistryTabulationMethod<CompType, ThermoType>>
         (
