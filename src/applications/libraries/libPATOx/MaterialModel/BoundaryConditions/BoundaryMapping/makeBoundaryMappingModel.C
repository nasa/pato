...
defineTypeNameAndDebug(twoDaxiInterpolateNearestBoundaryMappingModel, 0);
addToRunTimeSelectionTable(simpleBoundaryMappingModel, twoDaxiInterpolateNearestBoundaryMappingModel, fvMesh);
