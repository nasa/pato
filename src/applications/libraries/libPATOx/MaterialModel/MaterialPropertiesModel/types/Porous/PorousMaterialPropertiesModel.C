...
Switch Foam::PorousMaterialPropertiesModel::init()
{
  if(this->debug_) {
...
void Foam::PorousMaterialPropertiesModel::updatek()
{
...
void Foam::PorousMaterialPropertiesModel::updateCp()
{
  LinearInterpolationMaterialPropertiesObject& virgin = virginObject();
  LinearInterpolationMaterialPropertiesObject& charred = charObject();
  forAll(cp_, i) {
...
void Foam::PorousMaterialPropertiesModel::updateHbar()
{
  LinearInterpolationMaterialPropertiesObject& virgin = virginObject();
  LinearInterpolationMaterialPropertiesObject& charred = charObject();
...
void Foam::PorousMaterialPropertiesModel::updateHc()
{
  LinearInterpolationMaterialPropertiesObject& charred = charObject();
  forAll(h_c_, cellI) {
...
void Foam::PorousMaterialPropertiesModel::updateEmissivityAbsorptivity()
{
  LinearInterpolationMaterialPropertiesObject& virgin = virginObject();
  LinearInterpolationMaterialPropertiesObject& charred = charObject();
...
void Foam::PorousMaterialPropertiesModel::readEpsI()
{
...
void Foam::PorousMaterialPropertiesModel::readRhoI()
{
  fileName constPropFile = materialPropertiesDirectory+"/constantProperties";
  if (isFile(constPropFile)) {
    Info << "Reading " << constPropFile << endl;
