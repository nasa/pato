...
Foam::FiniteRateChemistryTabulationMethod<CompType, ThermoType>::FiniteRateChemistryTabulationMethod
(
...
template<class CompType, class ThermoType>
Foam::FiniteRateChemistryTabulationMethod<CompType, ThermoType>::
~FiniteRateChemistryTabulationMethod()
{}
