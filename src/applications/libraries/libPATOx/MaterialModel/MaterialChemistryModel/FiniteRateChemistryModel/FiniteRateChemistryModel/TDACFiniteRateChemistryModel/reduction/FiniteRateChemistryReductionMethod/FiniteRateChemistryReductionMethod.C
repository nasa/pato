...
Foam::FiniteRateChemistryReductionMethod<CompType, ThermoType>::FiniteRateChemistryReductionMethod
(
    const Foam::IOdictionary& dict,
    Foam::TDACFiniteRateChemistryModel<CompType, ThermoType>& chemistry
)
  :
dict_(dict),
...
template<class CompType, class ThermoType>
Foam::FiniteRateChemistryReductionMethod<CompType, ThermoType>::
