...
Foam::DarcyForchheimerLaw2TMassModel::DarcyForchheimerLaw2TMassModel
(
    const fvMesh& mesh,
...
Tg_(energyModel_.refVolField<scalar>("Tg")),
...
void Foam::DarcyForchheimerLaw2TMassModel::update()
{
...
void Foam::DarcyForchheimerLaw2TMassModel::beforeSolve()
{
  ...
  (
      ...
      /(
          mu + Beta.component(Tensor<double>::XX)*p*M/(R*Tg_)*mag(U)
          *K.component(Tensor<double>::XX)
      )
  );
  Gamma.replace
  (
      ...
      /(
          mu + Beta.component(Tensor<double>::XY)*p*M/(R*Tg_)*mag(U)
          *K.component(Tensor<double>::XY)
      )
  );
  Gamma.replace
  (
      ...
      /(
          mu + Beta.component(Tensor<double>::XZ)*p*M/(R*Tg_)*mag(U)
          *K.component(Tensor<double>::XZ)
      )
  );
  Gamma.replace
  (
      ...
      /(
          mu + Beta.component(Tensor<double>::YX)*p*M/(R*Tg_)*mag(U)
          *K.component(Tensor<double>::YX)
      )
  );
  Gamma.replace
  (
      ...
      /(
          mu + Beta.component(Tensor<double>::YY)*p*M/(R*Tg_)*mag(U)
          *K.component(Tensor<double>::YY)
      )
  );
  Gamma.replace
  (
      ...
      /(
          mu + Beta.component(Tensor<double>::YZ)*p*M/(R*Tg_)*mag(U)
          *K.component(Tensor<double>::YZ)
      )
  );
  Gamma.replace
  (
      ...
      /(
          mu + Beta.component(Tensor<double>::ZX)*p*M/(R*Tg_)*mag(U)
          *K.component(Tensor<double>::ZX)
      )
  );
  Gamma.replace
  (
      ...
      /(
          mu + Beta.component(Tensor<double>::ZY)*p*M/(R*Tg_)*mag(U)
  ...
  (
      ...
      K.component(Tensor<double>::ZZ)
      /(
          mu + Beta.component(Tensor<double>::ZZ)*p*M/(R*Tg_)*mag(U)
          *K.component(Tensor<double>::ZZ)
      )
  );
  Gamma.field()*=p()*M()/(R.value()*Tg_());
  Gamma.boundaryFieldRef() *=
      p.boundaryField()*M.boundaryField()/(R.value()*Tg_.boundaryField());
...
void Foam::DarcyForchheimerLaw2TMassModel::afterSolve()
{
  ...
  v = - 1./eps_g*(((Gamma*R*Tg_/(p*M)) & fvc::grad(p))
                  - (((Gamma*R*Tg_/(p*M))*rho_g) & g));
